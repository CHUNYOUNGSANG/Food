...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseDto> createComment(
        ...
        log.info("댓글 작성 요청: postId={}, memberId={}, content={}",
                postId, memberId, requestDto.getContent());
    ...
    public ResponseEntity<List<CommentResponseDto>> getCommentsByMember(
        ...
        log.info("회원 댓글 목록 조회 요청: memberId={}", memberId);
    ...
    public ResponseEntity<CommentResponseDto> updateComment(
        ...
        log.info("댓글 수정 요청: commentId={}, memberId={}, postId={}", commentId, memberId, postId);
